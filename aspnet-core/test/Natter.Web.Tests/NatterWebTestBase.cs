...
{
    public abstract class NatterWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NatterWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NatterWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NatterDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NatterDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NatterDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NatterDbContext, Task<T>> func)
        {
            T result;
